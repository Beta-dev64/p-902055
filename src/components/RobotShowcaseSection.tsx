...
const RobotShowcaseSection = () => {
  ...
  return (
    <section ref={sectionRef} className="w-full py-20 bg-muted" id="robot-showcase">
      <div className="container px-6 lg:px-8 mx-auto">
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          ...
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                ...
                <button className="px-6 py-3 btn-motion bg-pulse-500 hover:bg-pulse-600 text-white font-medium rounded-full transition-colors duration-300">
                  Learn More
                </button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="rounded-xl border border-border bg-card p-6 shadow-elegant transition-all duration-300 hover:-translate-y-1 hover:shadow-elegant-hover">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-primary/15 text-primary transition-transform duration-300 hover:scale-110">
              ...
              <h4 className="mb-2 text-lg font-semibold text-foreground">Advanced Sensors</h4>
              <p className="text-muted-foreground">High-precision sensors provide real-time environmental awareness and object recognition.</p>
            </div>
            ...
            <div className="rounded-xl border border-border bg-card p-6 shadow-elegant transition-all duration-300 hover:-translate-y-1 hover:shadow-elegant-hover">
              ...
              <h4 className="mb-2 text-lg font-semibold text-foreground">Adaptive Learning</h4>
              <p className="text-muted-foreground">Continuously learns from interactions to improve performance and personalize responses.</p>
            </div>
            ...
            <div className="rounded-xl border border-border bg-card p-6 shadow-elegant transition-all duration-300 hover:-translate-y-1 hover:shadow-elegant-hover">
              ...
              <h4 className="mb-2 text-lg font-semibold text-foreground">Fluid Movement</h4>
              <p className="text-muted-foreground">Engineered for natural, human-like movement with high degrees of freedom in all joints.</p>
            </div>
          </div>
        </div>
      </div>
