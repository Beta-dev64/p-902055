...
const AcademyFooter = () => (
  <footer className="academy-footer footer-poster relative isolate overflow-hidden border-t border-[#D8D0C5] bg-[#F5F1EA] text-[#1B2430]">
    ...
    <div className="footer-wordmark academy-footer-wordmark" aria-hidden="true">FuseLabs</div>
  </footer>
);
