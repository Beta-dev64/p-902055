  ...
  <section id="hero" className="relative isolate flex min-h-[min(900px,100svh)] items-end overflow-hidden bg-[#100e0c] pt-32">
    ...
    <div className="relative mx-auto grid w-full max-w-[1440px] gap-12 px-5 pb-14 sm:px-8 lg:grid-cols-[1.04fr_0.96fr] lg:items-end lg:px-12 lg:pb-20">
      <div className="max-w-3xl">
        <div className="mb-9 flex items-center gap-4 text-[#F7F1E8]/70"><BrandLockup light compact /><span className="h-px w-10 bg-[#DE8321]/70" /><span className="eyebrow">Build / Ship / Grow</span></div>
        <p className="eyebrow mb-5 text-[#DE8321]">The technical partner for ambitious teams</p>
        <h1 className="font-display text-[clamp(4rem,9.8vw,9.8rem)] font-medium leading-[0.82] tracking-[-0.09em] text-[#F7F1E8]">Make the <em className="text-[#DE8321]">next</em><br />stage shippable.</h1>
        <p className="mt-8 max-w-xl text-lg leading-relaxed text-[#C9C0B5] sm:text-xl">FuseLabs helps founders and growing teams turn difficult product ideas into reliable software, from first release to the systems that make growth repeatable.</p>
      ...
      <div className="flex justify-start lg:justify-end">
        <div className="hero-note max-w-xs border-l border-[#DE8321]/60 pl-5 text-sm leading-relaxed text-[#B3A99D] lg:mb-8">
